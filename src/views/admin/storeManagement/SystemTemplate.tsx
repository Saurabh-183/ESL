    ...
    <div className="p-4">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#262262] text-white px-4 py-[8px] rounded hover:cursor-pointer active:scale-90 transition-transform duration-100"
        >
          <Plus size={16} /> Add 11
        </button>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-white bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-gray-100 p-6 rounded shadow w-full max-w-md space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="bg-[#262262] text-white px-4 py-2 font-medium rounded active:scale-90 transition-transform duration-75"
              >
                Confirm
              </button>
            </div>
